...
This guide explains how to export and use cookies.txt for SSR_CLIPPER.
...
6. Upload the file in SSR_CLIPPER home page
...
6. Upload file di halaman utama SSR_CLIPPER
